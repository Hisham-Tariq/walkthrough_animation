...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/reading_book.png
  AssetGenImage get readingBook =>
      const AssetGenImage('assets/images/reading_book.png');

  /// File path: assets/images/relax.png
  AssetGenImage get relax => const AssetGenImage('assets/images/relax.png');

  /// File path: assets/images/riding_bike.png
  AssetGenImage get ridingBike =>
      const AssetGenImage('assets/images/riding_bike.png');

  /// File path: assets/images/yoga.png
  AssetGenImage get yoga => const AssetGenImage('assets/images/yoga.png');

  /// List of all assets
  List<AssetGenImage> get values => [gym, readingBook, relax, ridingBike, yoga];
}
